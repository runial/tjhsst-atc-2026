...
export const metadata: Metadata = {
  title: "TJ ATC - Home",
  description: "The official website for the Assistive Technology Club at TJHSST. Learn more about our projects, events, and how to get involved.",
  ...
  openGraph: {
    ...
    description: "The official website for the Assistive Technology Club at TJHSST.",
